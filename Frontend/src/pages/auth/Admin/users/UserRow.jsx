// src/pages/auth/Admin/users/UserRow.jsx - RESOLVED
...
export default function UserRow({ user, onEdit, onDelete }) { // Pilihan: madd (hanya export component)
  const formatDate = (date) => {
    if (!date) return "-";
    const d = new Date(date);
    return isNaN(d) ? "-" : d.toLocaleDateString("id-ID");
  }; // Pilihan: madd (fungsi formatDate)
